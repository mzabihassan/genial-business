...
export function Prose({
  ...
  return (
    <div
      className={cx(
        "max-w-2xl text-[0.9375rem] leading-relaxed text-ink-soft md:text-base",
        ...
        "[&_dl]:mt-4 [&_dt]:mt-3 [&_dt]:font-mono [&_dt]:text-[0.6875rem] [&_dt]:uppercase [&_dt]:tracking-[0.11em] [&_dt]:text-ink-mute [&_dd]:text-ink",
